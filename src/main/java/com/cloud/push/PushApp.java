...
import com.cloud.push.client.OAuth2InterceptedFeignConfiguration;
import com.cloud.push.config.ApplicationProperties;
import com.cloud.push.config.DefaultProfileUtil;
...
public class PushApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(PushApp.class);

    private final Environment env;

    public PushApp(Environment env) {
        this.env = env;
    }
